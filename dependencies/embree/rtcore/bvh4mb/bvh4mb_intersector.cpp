...
namespace embree
{
  ...
  void BVH4MBIntersector<TriangleIntersector>::intersect(const Ray& ray, const std::vector<int>& forbidden, Hit& hit) const
  {
    AVX_ZERO_UPPER();
    ...
    next:
      ...
      else 
      {
        ...
        for (size_t i=0; i<num; i++)
          TriangleIntersector::intersect(ray,hit,tri[i],bvh->vertices,forbidden);
